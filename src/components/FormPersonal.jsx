    ...
    return (
        <div className='space-y-4 text-[hsl(213,96%,18%)]'>
            <div className='space-y-2'>
                ...
                <input type="text" name="name" value={formData.name} onChange={handleChange} className='p-2 md:p-4 border block w-full' placeholder="e.g. Stephen King"
                />
            </div>
            <div className='space-y-2'>
                ...
                <input type="email" name="email" value={formData.email} onChange={handleChange} className='p-2 md:p-4 border block w-full' placeholder="e.g. stephenking@lorem.com" />
            </div>
            <div className='space-y-2'>
                ...
                <input type="text" name="number" value={formData.number} onChange={handleChange} className='p-2 md:p-4 border block w-full' placeholder="e.g. +1 234 567 890" />
            </div>
        </div>
    )
}
